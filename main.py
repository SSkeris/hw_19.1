                ...
                <div class="col-6">
                    <form>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputName1" placeholder="Имя"
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="collapse multi-collapse" id="multiCollapseExample1">
                                <div class="card card-body">
                                    text1 12312312asd asd asd asdas da sdahbs dgvuas
                                    vghasvgasvgjavgsdvsgahdvhgasvhgd as   d agads gv hdasgvhda
                                    sgvhdas gvhd asgvhdas gvhdsa vgdha s
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="collapse multi-collapse" id="multiCollapseExample2">
                                <div class="card card-body">
                                    text2 12312312asd asd asd asdas da sdahbs dgvuas
                                    vghasvgasvgjavgsdvsgahdvhgasvhgd as   d agads gv hdasgvhda
                                    sgvhdas gvhd asgvhdas gvhdsa vgdha s
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="collapse multi-collapse" id="multiCollapseExample3">
                                <div class="card card-body">
                                    taxt3 12312312asd asd asd asdas da sdahbs dgvuas
                                    vghasvgasvgjavgsdvsgahdvhgasvhgd as   d agads gv hdasgvhda
                                    sgvhdas gvhd asgvhdas gvhdsa vgdha s
                                </div>
                            </div>
